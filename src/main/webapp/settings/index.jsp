		...
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='/static/login.jsp';">更新</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="window.location.href='/static/login.jsp';">确定</button>
				</div>
			</div>
		</div>
	</div>
			...
			<ul>
				<li class="dropdown user-dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="/static/workbench/index.jsp"><span class="glyphicon glyphicon-home"></span> 工作台</a></li>
						<li><a href="/static/settings/index.jsp"><span class="glyphicon glyphicon-wrench"></span> 系统设置</a></li>
		...
		<div style="position: relative; width: 55%; height: 70%; left: 22%;">
			...
			<div style="position: relative; width: 33%; height: 50%;">
				...
				<a href="org/index.html" style="text-decoration: none; color: red;">组织机构</a>
				 -->
				<a href="dept/index.jsp" style="text-decoration: none; color: red;">部门管理</a>
				<br>
				<a href="qx/index.jsp" style="text-decoration: none; color: red;">权限管理</a>
			</div>
			...
			<div style="position: relative; width: 34%; height: 50%; left: 66%; top: -200%">
				数据管理
				<br><br>
				<a href="/settings/dictionary/index.jsp" style="text-decoration: none; color: red;">数据字典表</a>
				<br>
